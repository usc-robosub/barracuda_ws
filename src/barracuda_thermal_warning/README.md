...
The default thresholds are intentionally low so it is easier to verify ROS messaging
without needing to actually overheat the Jetson during early testing.
